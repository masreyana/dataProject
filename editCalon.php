...
$result = mysqli_query($con,"SELECT * FROM calon");
?>
<!DOCTYPE html>
...
<h1 style="color:#ff9999;margin-center:30px;">Maklumat Calon</h1><br>
...
?>
	...
	<tr>
		...
		<th>Surat Tawaran Belajar</th>
		<th>Semester Semasa</th>
	  ...
	  <td><?php echo $row["id_calon"]; ?></td>
        ...
        <td><a href="Surat Tawaran/<?php echo $row['filename'] ?>" target="_blank">view file</a></td>
		<td><?php echo $row["semester"]; ?></td>
		<td><?php echo $row["program"]; ?></td>
		<td><?php echo $row["pusat"]; ?></td>
